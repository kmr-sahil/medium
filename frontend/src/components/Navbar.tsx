...
function Navbar() {
  return (
    <div className='border-b pb-[1rem] mb-[1rem] flex md:px-[2rem] justify-between items-center'>
        
        <Link to={'/'} className='text-[1.2rem] md:text-[1.6rem] font-semibold font-serif'>Medium</Link>
